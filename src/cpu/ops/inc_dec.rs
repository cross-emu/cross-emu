...
impl<M: MemoryMapper> Cpu<M> {
    ...
    pub fn dec_r8<Reg: Reg8>(&mut self, _bus: &mut M) {
        ...
        self.flags
            .set_flag(Flag::Zero, Self::get_r8::<Reg>(self) == 0);
        self.flags.set_flag(Flag::Subtract, true);
        self.flags
            .set_flag(Flag::HalfCarry, (Self::get_r8::<Reg>(self) & 0x0F) == 0x0F);
    }
